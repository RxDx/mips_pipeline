...
architecture arq_alu_ctl of alu_ctl is
    ...
    constant F_slti : std_logic_vector(5 downto 0) := "001010"; -- SLTI cujo OPCODE=001010
    ...
    begin
        case ALUOp is 
			...
			case Funct is 
                        	...
                        	when F_slti  => ALUOperation <= ALU_slt; -- se OPCODE=SLTI entao ALU faz operacao igual ao SLT
